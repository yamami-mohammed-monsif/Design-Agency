...
const About = () => {
  return (
    <Section id="about">
      <div className="flex flex-col gap-[30px] md:gap-10 lg:gap-[60px]">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center gap-[30px] md:gap-10 lg:gap-[56px]">
          <div className="w-full lg:w-2/5 mx-auto lg:mx-0">
          ...
          <div className="w-full lg:w-3/5 flex flex-col gap-4 md:gap-5 text-center md:text-left">
            <p className="paragraph">
              We believe that a strong brand is the cornerstone of every
              successful business. We are a passionate team of branding experts
              dedicated to helping businesses like yours create a unique and
            ...
            <p className="paragraph">
              ...
              capture attention but also foster trust, loyalty, and recognition.
            </p>
          </div>
        </div>
      </div>
